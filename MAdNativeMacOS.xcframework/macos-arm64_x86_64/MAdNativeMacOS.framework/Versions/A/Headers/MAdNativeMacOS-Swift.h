...
#ifndef MADNATIVEMACOS_SWIFT_H
#define MADNATIVEMACOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MAdNativeMacOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14MAdNativeMacOS6AdInit")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS14AdResponseCode")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS14AdResponseInfo")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS13BaseUrlConfig")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS12GDPRSettings")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS16GlobalProperties")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS13TagProperties")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS15NativeAdRequest")
...
SWIFT_PROTOCOL("_TtP14MAdNativeMacOS23NativeAdRequestDelegate_")
...
@class XandrNativeAdView;
@class NSView;

SWIFT_CLASS("_TtC14MAdNativeMacOS16NativeAdResponse")
...
@property (nonatomic, strong) NSImage * _Nullable mainImage;
/// The icon image size
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (BOOL)registerTableRowViewForTracking:(NSTableRowView * _Nonnull)view withRootViewController:(NSViewController * _Nonnull)rvc clickableViews:(NSArray<XandrNativeAdView *> * _Nonnull)views completionHandler:(void (^ _Nullable)(BOOL, NSError * _Nullable))completionHandler SWIFT_WARN_UNUSED_RESULT;
- (BOOL)registerViewForTracking:(NSView * _Nonnull)view withRootViewController:(NSViewController * _Nonnull)rvc clickableViews:(NSArray<XandrNativeAdView *> * _Nonnull)views completionHandler:(void (^ _Nullable)(BOOL, NSError * _Nullable))completionHandler SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP14MAdNativeMacOS24NativeAdResponseDelegate_")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS18NativeAdStarRating")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS24NativeStandardAdResponse")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS11SDKSettings")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS6UserId")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS10XandrImage")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS17XandrNativeAdView")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS9XandrView")
...
SWIFT_CLASS("_TtC14MAdNativeMacOS19XandrViewController")
